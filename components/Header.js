    ...
    <header className="glass-card m-4">
      <div className="container mx-auto px-4 max-w-6xl flex flex-col md:flex-row justify-between items-center py-6">
        <div className="flex items-center space-x-4 mb-4 md:mb-0">
          ...
          <h1 className="text-3xl font-bold gradient-text">PlayListify</h1>
        </div>
          ...
          {!session ? (
            <>
              <button 
                ...
                className="btn-gradient text-white font-medium py-2.5 px-5 rounded-full flex items-center space-x-2 hover:scale-105"
              >
            ...
            <div className="flex items-center gap-4">
              {session.user?.image && (
                <div className="glass-card p-1 rounded-full animate-float">
                  <img 
